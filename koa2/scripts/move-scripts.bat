...
pause
", "file_path": "D:\WorkSpace\code\MyProject\llm-ai-agent\vite-vue3-NaïveUI-pinia\koa2\scripts\move-scripts.bat"}{"file_path": "D:\WorkSpace\code\MyProject\llm-ai-agent\vite-vue3-NaïveUI-pinia\koa2\move-scripts.bat